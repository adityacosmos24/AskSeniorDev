    ...
    <nav className="w-full h-16 bg-sky-50 border-b border-sky-100">
      <div className="max-w-7xl mx-auto h-full flex items-center px-4 md:px-6">
        ...
        <div className="flex-1 max-w-2xl hidden md:block">
          <span className="font-semibold px-15">Content Manager</span>
        </div>

        {/* Right Section */}
        <div className="ml-auto flex items-center gap-2 md:gap-3">
          <button className="font-semibold bg-[#00A3FF] text-white px-2 py-1 rounded-[2px] shadow-sm hover:bg-[#0092e6] hover:shadow-md active:scale-[0.98] transition-all duration-200">
            Create New Course
          </button>
        </div>
      </div>
