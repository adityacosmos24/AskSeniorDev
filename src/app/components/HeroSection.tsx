...
export default function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden bg-white">
      ...
      {/* ================= HERO CONTENT (LOCKED COMPOSITION) ================= */}
            ...
            >
              ...
              >
                <div
                  ...
                  "
                >
                  <QuoteIcon className="absolute -top-4 -left-4 w-6 h-6 text-[#00A3FF] bg-[#EAF7FF] backdrop-blur-md" />
                  ...
                  <QuoteIcon className="absolute -bottom-4 -right-4 w-6 h-6 rotate-180 text-[#00A3FF] bg-white" />
                </div>
              </div>
            </motion.div>
          </div>
